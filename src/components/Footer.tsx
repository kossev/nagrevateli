  ...
  return (
    <footer className="bg-slate-950 text-slate-200 py-12 mt-auto">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-xl font-bold text-white mb-4 uppercase">ЕТ-НАСКО ВЕЛИКОВ</h3>
          <p className="text-slate-400 text-sm leading-relaxed">
            Над 20 години опит в производството на качествени електрически нагреватели и професионални скари за дома и индустрията.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center space-x-3">
              ...
              <span>office@nasko-velikov.com</span>
            </li>
            <li className="flex items-center space-x-3">
              <MapPin className="h-4 w-4 text-orange-500" />
              <span>гр. Хасково, Промишлена зона</span>
            </li>
          </ul>
        </div>
      </div>
      <div className="container mx-auto px-4 mt-8 pt-8 border-t border-slate-800 text-center text-xs text-slate-500">
        © {new Date().getFullYear()} ЕТ-НАСКО ВЕЛИКОВ. Всички права запазени.
      </div>
    </footer>
  );
};
